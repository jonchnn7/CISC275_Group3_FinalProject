...
/**
 * Creates a JButton to be used in the construction of the game's overlay menu.
 * The minimum requirements are an ImageIcon to use as the button and its
 * corresponding width and height. Optionally, an additional ImageIcon can be
 * used as the button's rollover icon.
 * <p>
...
public class ViewOverlayButton extends JPanel {
	...
	/**
	 * Creates a new JButton given an ImageIcon and, potentially, an additional
	 * ImageIcon to use as the rollover image.
	 */
	...
	/**
	 * Returns pointer to the button. Allows the controller to create the button
	 * action
	 * 
