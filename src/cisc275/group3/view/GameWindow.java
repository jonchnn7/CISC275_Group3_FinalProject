...
/**
 * Largest level container used to hold the game view. The primary component is
 * a JLayeredPane which holds the individual views (Title, Map, Bay, etc).
 * <p>
 * 
 * @author Scott
 */
...
public class GameWindow extends JFrame {
	...
	/**
	 * Constructor takes in two int's to set the window width and height. We then
	 * construct the main JLayeredpane, and set its attributes so it doesn't
	 * collapse on pack().
	 * 
	 * @param w
	 *            int-width
