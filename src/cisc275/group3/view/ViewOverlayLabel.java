...
/**
 * Creates a JLabel to be used in the construction of the game's overlay menu.
 * The minimum requirements are an
 * <p>
...
public class ViewOverlayLabel extends JPanel {
	...
	/**
	 * Sets JLabel properties for both a pure text or text+image JLabel.
	 */
