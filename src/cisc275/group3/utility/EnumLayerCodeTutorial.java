...
public enum EnumLayerCodeTutorial {
  ...
  ButtonGetScoreTime(17), LabelScoreTimeSpeech(14),
  MainTop(10),
  TitleScreen(-1), TutorialScreen(-2), ControllerHQ(-3),
  ButtonGetMissionHidden(-10), LabelGetMissionHidden(-11),
  ButtonGetScoreTimeHidden(-17), LabelScoreArrowHidden(-16), LabelTimeArrowHidden(-15),LabelScoreTimeSpeechHidden(-14),
  ...
  LabelScoreHidden(-80), LabelTimeHidden(-85), LabelMapSpeechHidden(-81), LabelMapArrowHidden(-88);
