...
public interface ConstructCrab {
  ...
  static final String[] LEFT_FILE = 
	  {"img/crabLeft_red_icon.png", "img/crab_blue_icon.png" , "img/horeshoeCrabLeft.png"};
  static final String[] RIGHT_FILE = 
	  {"img/crabRight_red_icon.png", "img/crab_blue_icon.png", "img/horeshoeCrabRight.png" };
  ...
  // Crab Width
  static final double[] CRAB_WIDTH = {100, 125, 177};
	  
  // Crab Aspect Ratios (multiply by width for height)
  static final double[] CRAB_AR = {1.442, 0.5988, 0.8475};
