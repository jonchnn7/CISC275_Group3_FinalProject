...
EndGame(25), MainTop(20),
  MissionFact(6), InventoryOverlay(14), InventoryButton(13), Mission(12), MapButton(11), MapOverlay(10), MainMap(9), // Layers for Map + Game Only
  ...
  Map(-9), Title(-10), Tools(-11), Wetland(-13), Tutorial(-14), MissionHide(-15), EndGameHide(-16),  // "Hidden" Layers
MissionFactHide(-17);
