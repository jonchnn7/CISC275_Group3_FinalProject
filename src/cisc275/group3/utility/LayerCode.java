...
public enum LayerCode {
  MainTop(20),
  MissionFact(15),  Mission(12), MapButton(11), MapOverlay(10), MainMap(9), // Layers for Map + Game Only
  ...
  Map(-9), Title(-10), Tools(-11), Tutorial(-12), Wetland(-13), MissionHide(-15),  // "Hidden" Layers
