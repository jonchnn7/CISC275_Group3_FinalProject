...
public enum LayerCode {
  ...
  MissionRequest(16), MissionFact(15), InventoryOverlay(14), InventoryButton(13), 
  ...
  MissionHide(-15), MissionFactHide(-16), MissionRequestHide(-17), EndGameHide(-18);  // "Hidden" Layers
