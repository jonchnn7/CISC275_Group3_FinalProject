...
public enum LayerCode {
  ...
  MissionFact(15), InventoryOverlay(14), InventoryButton(13), 
  ...
  Map(-9), Title(-10), Tools(-11), Wetland(-13), Tutorial(-14), 
  MissionHide(-15), MissionFactHide(-16), EndGameHide(-17);  // "Hidden" Layers
