...
public class Game extends Canvas {
	 ...
	 * Game.java
	 * 
	 * This class serves as the controller in our MVC model.
	 */
	...
	private Color[] color_list = { Color.black, Color.cyan, Color.darkGray, Color.magenta, Color.red, Color.yellow,
			Color.orange };
	...
	private void gameLoop() {
		...
		while (true) {
			...
			((LowerInterfaceScene) interface_bars.get("LOWER")).drawScene(g, current_scene.getTime(),
					current_scene.getScore(), activeMission.toString());
